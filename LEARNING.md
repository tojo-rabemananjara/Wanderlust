# 17. Async JS and HTTP Requests

## Requests

*   clientId
*   clientSecret
    *   know to occlude api keys etc. from public repositories via for instance gitignore
...
const createVenueHTML = (name, location, iconSource) => {
  ...
  const createWeatherHTML = (currentDay) => {
    ...
    return `<h2>${weekDays[(new Date()).getDay()]}</h2>
      ...
      <h2>Percent Humidity: ${currentDay.main.humidity}%</h2>
...
//config.js
var config = {
	fs_clientId: 'HJBXVUTJSBNPWKUGBURX1IAJYDQ3DAH4GHZCAPAY0KUJ4MSB',
	fs_clientSecret: 'OX3N2M1XCM4QTX5MEYDBU2IXT3X4KMR4FSPLEWQAMHFN4HW3',
	openWeatherKey: '760508e7777ef50d73f313dc2ac01d11'
}

```

*   Some jQuery in there etc.
*   `fetch` `async` `await`
